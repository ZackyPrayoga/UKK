...
<script>
    ...
    $(function () {
        ...
        $('.btn-simpan').on('click', function () {
            ...
            // Check if kode_produk field is empty
            if ($('#kode_produk').val() == "") {
                alert('Mohon isi Kode Produk terlebih dahulu.');
                return; // Stop further execution of code
            }

            // If kode_produk field is not empty, submit the form
